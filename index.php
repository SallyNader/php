...
@$_POST['username'] ?>">
						...
						<input type="text" placeholder="E-Mail" name="email" value="<?php echo @$_POST['email'] ?>">
...
if (isset($_POST['submit'])) {
    ...
    $required = array(
        'username' => 'username',
        'lengthusername' => 'username can not be less than 5 charachters',
        'password' => 'password',
        'confirmpassword' => 'confirm password please',
        'email' => 'email',
        'type' => 'select student or instructor',
        'email_success' => 'Thank you! Your email has been sent',
        'invalid_email' => 'enter email in form of example@hotmail.com',
        'email_error' => 'There was a problem sending your email. Please try again',
        'weakpassword' => "password very weak can't be less than 6 charcters",
    ...
    if (strlen($username) < 5)
        $error[] = $required['lengthusername'];


    if (!filter_var($email, FILTER_VALIDATE_EMAIL))
        $error[] = $required['invalid_email'];
    if (strlen($password) < 6)
        $error[] = $required['weakpassword'];
    if (!isset($_POST['type']))
        $error[] = $required['type'];
    if (empty($username) or empty($password) or empty($confirmpass) or empty($email) or
        empty($country)) {

        echo "<script type='text/javascript'>alert('fill blank inputs please !!');</script>";


    }


    if (!empty($username) and !empty($password) and !empty($confirmpass) and !empty
        ($email) and !empty($country)) {

        if (empty($error)) {


            if ($_POST['type'] == "student") {
                $sql = "insert into users (userName,	typeOfAccess,password,country,email	)values('" .
                    $username . "','1','" . md5($password) . "','" . $country . "','" . $email .
                    "')";
            ...
            if ($_POST['type'] == "instructor") {
                $sql = "insert into users(userName,	typeOfAccess,password,country,email) values('" .
                    $username . "','2','" . md5($password) . "','" . $country . "','" . $email .
                    "')";
                $data = mysql_query($sql);
            }
            if ($data) {
...
<script>
 ...
 window.location.href = 'courseslogin.php';
...
?>
			...
			<section class="header" id="header">
				...
				<section class="virtual-button">
					<a href="virtual.php"><p>Try virtual class room</p></a>
				</section><!--******************** login-area section end ********************-->
				...
				<section class="slidshow">
					<div class="container12">
						<div class="column12">
							<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 10px; width: 606px; height: 305px; overflow: hidden; visibility: hidden; border: 3px ;">
						        <!-- Loading Screen -->
						        ...
						        <div data-u="slides" style="cursor: default; position: relative; top: 0px; left: 0px; width: 600px; height: 300px; overflow: hidden;border: 3px solid #FFF; border-radius: 5px; ">
						            <div data-p="112.50" style="display: none;">
						                <img data-u="image" src="imgs/02.jpg" />
						            </div>
						            <div data-p="112.50" style="display: none;">
						                <img data-u="image" src="imgs/04.jpg" />
						            </div>
						            <div data-p="112.50" style="display: none;">
						                <img data-u="image" src="imgs/05.jpg" />
						            </div>
						            <div data-p="112.50" style="display: none;">
						                <img data-u="image" src="imgs/09.jpg" />
						            </div>
						            <div data-p="112.50" style="display: none;">
						                <img data-u="image" src="imgs/10.jpg" />
						            </div>
						            <div data-p="112.50" style="display: none;">
						                <img data-u="image" src="imgs/11.jpg" />
						            </div>
						            <a data-u="ad" href="http://www.jssor.com" style="display:none">Bellnet Slider</a>
			...
			<section class="courses" id="courses">
				...
				<div class="items">
					...
					<div id="a8" class="item green">
						<div class="flipper-front">
							<h1><a href="courses.php">More categories</a></h1>
							<p class="icon-coin"></p>
						</div>
						<div class="flipper-back">
							<h2>500</h2>
			...
			<section id="contact" class="contact">
				...
				<form class="footer-form" action="index.php" method="post">
					<div class="container12">
						<div class="column4">
							<input class="column4" type="text" placeholder="Name" name="name">
						</div>

						<div class="column4">
							<input class="column4" type="text" placeholder="E-Mail" name="email">
						</div>

						<div class="column4">
							<input class="column4" type="text" placeholder="Subject"   name="subject" >
						</div>
...
if (isset($_POST['send'])) {
    ...
    $email = "sallynaderahmed@gmail.com";
...
function sanitize_string($string)
{
    ...
    return stripcslashes(filter_var($string, FILTER_SANITIZE_STRING,
